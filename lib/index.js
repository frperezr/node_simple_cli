...
program
  ...
  .action(name => CrudHelper.getContact(name));
...
program
  ...
  .action(_id => {
    prompt(questions).then((answers) =>
      CrudHelper.updateContact(_id, answers));
  });
...
program
  ...
  .action(_id => CrudHelper.deleteContact(_id));
...
program
  ...
  .action(() => CrudHelper.getContactList());
